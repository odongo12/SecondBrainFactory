...
Before writing a new panel, check this table and `10-TEMPLATES/panels.lib.js`.
...
outcome-table, before-after, stage-stepper.
...
`20-BUILDS/rnai-precision-crop-designer/`.
